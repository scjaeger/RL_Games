...
def test_backpropagate_single_layer():
    ...
    child = Node(root, state.perform_action((2, 2)))
...
def test_backpropagate_multi_layer():
    ...
    first_layer_child = Node(root, state.perform_action((1, 1)))
        # [0, 0, 0],
        # [2, 1, 0],
        # [1, 0, 0]
    
    second_layer_child = Node(first_layer_child, first_layer_child.state.perform_action((0, 0)))
        # [2, 0, 0],
        # [2, 1, 0],
        # [1, 0, 0]
        
    third_layer_child = Node(second_layer_child, second_layer_child.state.perform_action((0, 2)))
        # [2, 0, 1],
        # [2, 1, 0],
        # [1, 0, 0]
...
def test_backpropagate_multi_children():
    ...
    first_layer_child_1 = Node(root, state.perform_action((1, 1)))
        # [0, 0, 0],
        # [2, 1, 0],
        # [1, 0, 0]
    ...
    first_layer_child_2 = Node(root, state.perform_action((0, 0)))
        # [1, 0, 0],
        # [2, 0, 0],
        # [1, 0, 0]
    ...
    second_layer_child_1_2 = Node(first_layer_child_1, first_layer_child_1.state.perform_action((2,1)))
        # [0, 0, 2],
        # [2, 1, 0],
        # [1, 0, 0]
    ...
    second_layer_child_2_2 = Node(first_layer_child_1, first_layer_child_1.state.perform_action((0,0)))
        # [2, 0, 0],
        # [2, 1, 0],
        # [1, 0, 0]
